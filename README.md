...
- Clay Pits
- Camps
- Era multiplier effects (2x in Antiquity, 3x in Exploration Age, 4x in Modern Age)
...
- Domestic trade routes (+1 per route)
...
Shows Happiness and Gold bonuses per age from:

- Tiles with at least 1 happiness
- Natural Wonder Yield multiplier (+50%) \*No Era Multiplier

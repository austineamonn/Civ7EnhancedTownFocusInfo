// Internal Trade details renderer.
// - +5 Gold per connected city/town. -5 Trade Range
// - Header: total Gold (connections).
...
export default class InternalTradeDetails {
  /**
   * Returns HTML for Internal Trade focus, or null if no connections.
